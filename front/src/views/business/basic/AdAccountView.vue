<template>
  <div class="biz-page">
    <PageHeader title="广告账户管理" desc="各渠道广告投放账户管理" />
    ...
    <FilterBar>
      ...
      <el-form-item label="账户"><el-input v-model="account" placeholder="请输入账户" style="width:180px" /></el-form-item>
      <template #actions>
    ...
    <BaseTable :data="table" :total="56" :page="1" :page-size="10" @change="onPageChange">
      ...
      <el-table-column label="操作" width="160"><template #default="{ row }"><el-button text type="primary" @click="goDetail(row)">详情</el-button><el-button text type="primary">充值</el-button></template></el-table-column>
    </BaseTable>
...
onMounted(async () => { table.value = await systemApi.adAccounts() })
